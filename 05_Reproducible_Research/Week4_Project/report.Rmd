...
par(mar = c(10,4,2,2))
barplot(evtohealth$x, names.arg = evtohealth$Group.1, ylab="Health Impact", las=2)
```
...
evtohealth <- head(evtohealth[order(evtohealth$x, decreasing = T),], 10)
par(mar = c(10,4,2,2))
barplot(evtohealth$x / 10^6, names.arg = evtohealth$Group.1, ylab="Economic Damage in M$", las=2)
```
